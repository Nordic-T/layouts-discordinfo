          ...
          h('div#discordInfo',[
            h('div#_show_discordChannels',[
              h('span.wrapper',[
                ...
                h('span#_count_discordChannels.noselect','0')
            ...
            h('div#_show_discordMembers',[
              h('span.wrapper',[
                h(`i.fa.${users_faicon}`),
                h('span#_count_discordMembers.noselect','0')
                //h('span#type','Users')
              ])
            ]),
        ...
        function fetchData(){
          ...
          $.get('https://discordapp.com/api/servers/'+settings.serverIdentifier+'/embed.json', function(data){
            ...
            for (var i=0;i<data.members.length;i++)
            {
              ...
              members += "<div class='discord-user'><img src="+elem.avatar_url+" /><span>"+elem.username+"</span></div>";
            }
            // Populate channels
